...
# Параметры
BUNDLE_ID="com.geometricmini.game"
APPLE_ID="6755963289"
REMOTE_URL="git@github.com:sdeslvm/Geometric-Mini-Games.git"
PROJECT_NAME="Geometric Mini Games"
SCHEME_NAME="Geometric Mini Games"
