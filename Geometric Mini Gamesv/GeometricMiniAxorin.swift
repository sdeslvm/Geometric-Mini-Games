...
final class GeometricMiniBaseWebViewController: UIViewController, WKScriptMessageHandler {
    ...
    private let loader: GeometricMiniWebLoader
    private let coordinator: GeometricMiniWebCoordinator
    ...
    init(
        ...
        loader: GeometricMiniWebLoader,
        coordinator: GeometricMiniWebCoordinator,
    ...
    override func viewDidLoad() {
        ...
        GeometricMiniOrientationManager.shared.updateAllowedOrientations(defaultOrientations)
    ...
    override var supportedInterfaceOrientations: UIInterfaceOrientationMask {
        GeometricMiniOrientationManager.shared.currentMask
    }
    ...
    private func unlockOrientationIfNeeded() {
        ...
        GeometricMiniOrientationManager.shared.updateAllowedOrientations(.all)
    }
...
private extension GeometricMiniBaseWebViewController {
