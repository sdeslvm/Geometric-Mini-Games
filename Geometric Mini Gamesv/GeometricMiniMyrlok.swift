...
final class GeometricMiniOrientationManager {
    static let shared = GeometricMiniOrientationManager()
...
final class GeometricMiniAppDelegate: NSObject, UIApplicationDelegate {
    func application(
