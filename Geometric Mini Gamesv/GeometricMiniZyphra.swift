...
protocol WebLoadable: AnyObject {
    var state: GeometricMiniWebStatus { get set }
...
final class GeometricMiniWebLoader: NSObject, ObservableObject, WebLoadable, ProgressMonitoring {
    // MARK: - Свойства

  @Published var state: GeometricMiniWebStatus = .standby
    ...
    func observeProgression() {
        progressPublisher
            ...
            .sink { [weak self] progress in
                ...
                let newState: GeometricMiniWebStatus = progress < 1.0 ? .progressing(progress: progress) : .finished
...
extension GeometricMiniWebLoader: WKNavigationDelegate {
...
extension GeometricMiniWebLoader {
    ...
    func publish(_ newState: GeometricMiniWebStatus) {
...
private extension GeometricMiniWebLoader {
    func updateState(_ newState: GeometricMiniWebStatus) {
