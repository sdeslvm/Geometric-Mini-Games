...
class GeometricMiniWebCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
    private let callback: (GeometricMiniWebStatus) -> Void
    private var didStart = false

    init(onStatus: @escaping (GeometricMiniWebStatus) -> Void) {
