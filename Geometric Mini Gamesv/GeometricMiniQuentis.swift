...
enum GeometricMiniWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: GeometricMiniWebStatus) -> Bool {
        switch (self, other) {
...
extension GeometricMiniWebStatus {
...
extension GeometricMiniWebStatus {
    static func == (lhs: GeometricMiniWebStatus, rhs: GeometricMiniWebStatus) -> Bool {
